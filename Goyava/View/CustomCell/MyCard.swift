...
class MyCard: UIView {
    ...
    override func layoutSubviews(){
        if iconImageView != nil {
            ...
            CircleView.drawCircleOn(backgroundCicularview, color: UIColor.grayColor(), progress:2,lineWidth:5.0)
            CircleView.drawCircleOn(backgroundCicularview, color: UIColor(hexString:"29ABA9"), progress:1,lineWidth:5.0)
